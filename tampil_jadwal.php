...
<div class="art-postcontent">
  ...
  <tr>
    <td width=200><div align="center">Jurusan / Tingkat</div> </td>
    <td><td><select>Jurusan</option>
...
<? include "koneksi.php";
	$sql = "SELECT jadwal.kode_mk, matakuliah.matakuliah, matakuliah.sks, jadwal.hari, jadwal.jam_ke,dosen.nama_dosen, jadwal.ruangan FROM (jadwal left join dosen on jadwal.id_dosen = dosen.id_dosen)  left join  matakuliah on jadwal.kode_mk=matakuliah.kode_mk";
...
<table width="600" border=0 >
	...
	<td colspan=2><div align="center"> Diketahui oleh :</div></td>
    </tr>
    <tr>
	<td colspan=2><div align="center"> &nbsp;</div></td>
	<td colspan=1><div align="center"> &nbsp;</div></td>
	<td colspan=2><div align="center"> Direktur</div></td>
    </tr>
    <tr>
    ...
    <tr>
	<td colspan=2 width=200><div align="center"></div></td>
	<td colspan=1 width=200><div align="center"></div></td>
	<td colspan=2 width=200><div align="center">_______________</div></td>
    </tr>
</table>
