...
<table width="600" border="1">
  <tr>
    <td colspan="5"><div align="center">Daftar Mata Kuliah</div></td>
  ...
  <tr>
    ...
    <td ><input  type="text"/></td>
    <td><input size=11  type="text"/></td>
    <td><input  type="text"/></td>
  </tr>
  <tr>
    <td colspan=4><div align="right" >Jumlah SKS :</div></td>
    <td><input type="text"/></td>
  </tr>
  <tr>
    <td colspan=4><div align="right" >Ipk :</div></td>
    <td><input  type="text"/></td>
  </tr>
</table>
...
<table width="600" border=0 >
    <tr>
	<td colspan=5 ><div align="right"> Medan, ___________</div></td>
    </tr>
    <tr>
	<td colspan=2><div align="center"> &nbsp;</div></td>
	<td colspan=1><div align="center"> &nbsp;</div></td>
	<td colspan=2><div align="center"> Pembantu Ketua I</div></td>
    </tr>
    <tr>
